...
public:
    ...
    static vector<string> getListSeqs_allFamilies(const string &path_dir);
    ...
    static string getFileName(string filePath, bool withExtension = true, char seperator  = FastaFilesReader::separator());
